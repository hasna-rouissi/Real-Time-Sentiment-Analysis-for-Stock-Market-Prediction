...
def main():
    ...
    collection = db["predicted_impact_rf"]  # Collection dédiée au modèle RF

    print("Chargement des prédictions RF depuis MongoDB...")
    ...
    if data.empty:
        print("Pas de données valides pour évaluation après nettoyage.")
        return
